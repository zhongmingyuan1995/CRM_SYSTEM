			...
			<div class="col-sm-12">
				<div class="panel" style="height:100vh">
					<div class="panel-content">
						<div class="row">
							<div class="col-md-12">
								<form id="insertAssort">
									<blockquote class="b-darker-1 bl-md">
										<p>客户信息管理>客户信息>新建交往记录</p>
									</blockquote>
									<h5 class="mb-lg "></h5>
									<div class="col-md-12 right-operate">
										...
										<a onclick="insertAssort()" class="btn btn-default">
									...
									<div class="col-md-12" style="margin-top: 20px">
										<table class="table  table-bordered text-center">											
											<tr>
												...
												<td class="text-left"><input type="date"  name="atvDate" id="atvDate" onblur="checkatvDate()"
													class="form-control"></td>
												<th>地点<span class="must">*</span></th>
												<td class="text-left"><input type="text" name="atvPlace" id="atvPlace" onblur="checkatvPlace()"
													class="form-control"></td>
											</tr>
											<tr>
												<th>概要<span class="must">*</span></th>
												<td class="text-left"><input type="text" name="atvTitle" id="atvTitle" onblur="checkatvTitle()"
													class="form-control"></td>
												<th></th>
		...
		$(document).ready(function(){  
		 ...
		 function insertAssort(){
			 if(checkatvDate()&&checkatvPlace()&&checkatvTitle()){			
				 $.ajax({  
					    type: "POST",  
					    url:"<%=request.getContextPath()%>/insertAssort.as",  
					    data:$('#insertAssort').serialize(),  
					    async: false,  

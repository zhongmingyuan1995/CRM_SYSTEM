							...
							<form class="form-inline" id="updateconfig">
								<div class="col-md-12">
									...
									<div class="col-md-12 right-operate">
										...
										<a  onclick="queryLost()"class="btn btn-default">
											<i class="fa fa-check"></i>&nbsp;&nbsp;暂缓流失
										</a>										
										<a onclick="updateconfig()" class="btn btn-default">
									...
									<div class="col-md-12" style="margin-top: 20px">
										<table class="table  table-bordered text-center">
											...
											<tr>
												<th>流失原因</th>
												<td class="text-left" colspan="3"><textarea name="lstReason" id="lstReason" onblur="checklstReason()"
...
<script type="text/javascript">  
		$(document).ready(function(){  
		 ...
		 function checklstReason(){
			 var lstReason=document.getElementById("lstReason").value;  			 
			 if(lstReason==""){
				 $(".msg").text("流失原因不能为空！");
				 $("#mymodal").modal();	
				 return false;
		 ...
		 function updateconfig(){
			 if(checklstReason()){			
				 $.ajax({  
					    type: "POST",  
					    url:"<%=request.getContextPath()%>/updateconfig.ls",  
					    data:$('#updateconfig').serialize(),  
					    async: false,  
					    ...
					    success: function(data) { 
								...
								setTimeout("queryLostconfirm()",2000); 	
					    }  
					  });
			 }else{
		 ...
		 function queryLostconfirm(){
			 window.location.href='<%=request.getContextPath()%>/queryLost.ls'; 	
		 }
</script>
</body>
</html>